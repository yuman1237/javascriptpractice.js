...
function* fib(num){
    ...
    while(true){
        ...
        if(i>=num && i%num==0) 
         ...
         {yield arr.slice(i-num,i);}
        
    }

};

console.log(fib(6).next().value);
console.log(fib(6).next().value);
...
// {       
//     let arr=[];
//       arr =fib(num).next().value;
     
//         let arr1= filter(arr).next().value;
...
//   while (true) {
// 		let n = await fetch(url).then(res => res.json())
//     n *= 10
//     yield n
//   }
// }
